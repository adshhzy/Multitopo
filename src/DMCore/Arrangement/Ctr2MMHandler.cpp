...
void Ctr2ArHandler::processContourMM(const char* filename,Arrangement &ar){
    ...
    if(1)ContourHandler::preProcDataSingleMat(planenum, pparam, pctrvers, pctrvernum, pctredges, pctredgenum,
